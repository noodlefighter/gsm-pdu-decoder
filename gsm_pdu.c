...
UINT16 HexBuf2AsciiBuf(UINT8 *hexBuf, UINT8 hexBufLen, char *asciiStrng);
...
//***************************************************************************
UINT16 HexBuf2AsciiBuf(UINT8 *pHexBuf, UINT8 hexBufLen, char *pAsciiStrng)
{
	UINT8 idx = 0;
	UINT8 hexData = 0;
...
//***************************************************************************
UINT8 AsciiBuf2HexBuf(char *pAsciiStrng, UINT8 *pHexBuf)
{
	UINT8 idx = 0;
	UINT8 hexData = 0;
	UINT8 higherNibble = 0;
